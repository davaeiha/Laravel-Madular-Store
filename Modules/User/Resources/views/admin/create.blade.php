@component("admin.layout.content",["title"=>"فرم ایجاد کاربر"])
    @slot("breadcrumb")
        <ol class="breadcrumb float-sm-left">
            ...
            <li class="breadcrumb-item active">فرم ایجاد کاربر</li>
        </ol>
    ...
    <form class="form-horizontal" method="post" action="{{route("admin.users.store")}}">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputName3" placeholder="نام کاربر را وارد کنید">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="password-confirm" class="col-sm-2 control-label">پسورد تایید</label>
                <div class="col-sm-10">
