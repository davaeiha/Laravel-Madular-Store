    ...
    <form class="form-horizontal" method="post" action="{{route("admin.products.store")}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" id="inputName3" placeholder="نام محصول را وارد کنید" value="{{old('title')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="price" class="form-control" id="inputName5" placeholder="قیمت محصول را وارد کنید" value="{{old('price')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="number" name="inventory" class="form-control" id="inventory" placeholder="تعداد کالای موجود در انبار" value="{{old('inventory')}}">
                </div>
            </div>
