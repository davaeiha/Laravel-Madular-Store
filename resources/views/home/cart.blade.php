...
@section('content')
    <div class="container px-3 my-5 clearfix">
        ...
        <div class="card">
            ...
            @php
                $carts = \App\Helpers\cart\Cart::all();
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-0">
                        ...
                        <tr>
                            ...
                            @if(!\App\Helpers\cart\Cart::isAllWithoutDiscount())
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
                    ...
                    @else
                        <div class="mt-4">
                            ...
                            <span class="">  کد تخفیف: <span class="text-info  "> {{\App\Helpers\cart\Cart::getDiscount()->code}} </span> </span><br>
                            <span class="">  درصد تخفیف: <span class="text-info  "> {{\App\Helpers\cart\Cart::getDiscount()->percent}} درصد </span> </span>
